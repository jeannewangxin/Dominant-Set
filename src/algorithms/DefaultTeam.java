...
public class DefaultTeam {
	public ArrayList<Point> calculDominatingSet(ArrayList<Point> points, int edgeThreshold) {
		...
		*/
		...
		ArrayList<Point> result = (ArrayList<Point>) points.clone();
		for (int i = 0; i < 10; i++) {
			ArrayList<Point> doSet = localSearch1(deleteOne(points, greedy(points, edgeThreshold), edgeThreshold),
					points, edgeThreshold);
			System.out.println("MAIN. greedy and localsearch10 and localsearch21 Current sol: " + result.size() + ". Found next sol: " + doSet.size());
			if (doSet.size() < result.size())
				result = doSet;
		}
		...
		System.out.println("MAIN. localSearch32 result: " + result.size());
		return result;
